...
class CreateForm(forms.SelfHandlingForm):
    ...
    # DELL - Add dropdown list for images
    image_source = forms.ChoiceField(label=_("Bootable Volume"), required=False)
    # DELL - End of change
    ...
    def _get_available_images(self, request, **kwargs):
    ...
    def handle(self, request, data):
        try:
            ...
            # Saks Change 4 - add image id to api
            # Check image has been selected.
            image_source = data.get('image_source')
            if image_source == '':
                imageRef = None
            else:
                imageRef = image_source
            ...
            volume = cinder.volume_create(request,
                                          ...
                                          imageRef=imageRef,
                                          metadata=metadata)
            print """Pass the volume apil call"""
